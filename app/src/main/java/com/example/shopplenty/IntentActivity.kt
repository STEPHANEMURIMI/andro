...
Column (
        ...
        modifier = Modifier
            .fillMaxSize()
            .paint(
                painterResource(id = R.drawable.bann),
    ...
    TopAppBar(
        ...
        , actions = {
            ...
            IconButton(onClick = { /*TODO*/ }) {
                Icon(imageVector = Icons.Default.Place, contentDescription = "Menu",
                    tint = Color.White )
            ...
            IconButton(onClick = { /*TODO*/ }) {
                Icon(imageVector = Icons.Default.Favorite, contentDescription = "Menu",
                    tint = Color.White )
